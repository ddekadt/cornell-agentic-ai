...
**8 September.** They post a result on three related equations at the same time that OpenAI announces a solution to the Navier-Stokes Millium Prize problem, generated by roughly 10,000 agents working for 88 hours, using millions of dollars in compute.

--

OpenAI started working on the problem on 1 September after staff *"heard a rumor"* that someone at Anthropic had solved a Millenium Prize problem.
